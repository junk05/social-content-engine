...
class ManifestTest(unittest.TestCase):
    ...
    def test_no_sensitive_or_broad_permissions(self) -> None:
        forbidden = {"cookies", "webRequest", "history", "scripting", "<all_urls>"}
    ...
    def test_detail_navigation_is_isolated_to_user_started_batch(self) -> None:
        sources = "\n".join(
            (ROOT / name).read_text(encoding="utf-8")
            for name in ("detail_action.js", "content.js", "options.js")
        )
        ...
        self.assertIn("SCE_START_DETAIL_BATCH", (ROOT / "options.js").read_text())
        self.assertIn("chrome.tabs", (ROOT / "background.js").read_text())
